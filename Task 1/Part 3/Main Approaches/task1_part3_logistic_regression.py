...
# Function to train Logistic Regression and record validation accuracy
def train_logistic_regression_on_subsets(X_train, y_train, X_val, y_val):
...
percentages, accuracies = train_logistic_regression_on_subsets(X_train, y_train, X_val, y_val)

# Plotting the results
plt.figure(figsize=(12, 8))
plt.plot([p * 100 for p in percentages], accuracies, marker='o', label="Logistic Regression")

plt.title("Logistic Regression Validation Accuracy vs Training Data Percentage")
