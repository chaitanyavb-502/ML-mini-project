...
# Function to train CNN and record validation accuracy
def train_cnn_on_subsets(X_train, y_train, X_val, y_val):
    ...
    for p in percentages:
        ...
        model = build_cnn_model(X_train_subset.shape)
...
percentages, accuracies = train_cnn_on_subsets(X_train, y_train, X_val, y_val)

# Plotting the results
plt.figure(figsize=(12, 8))
plt.plot([p * 100 for p in percentages], accuracies, marker='o', label="CNN")

plt.title("CNN Validation Accuracy vs Training Data Percentage")
