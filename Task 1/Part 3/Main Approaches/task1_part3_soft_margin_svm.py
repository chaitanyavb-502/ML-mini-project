...
# Function to train Soft Margin SVM and record validation accuracy
def train_svm_on_subsets(X_train, y_train, X_val, y_val):
...
percentages, accuracies = train_svm_on_subsets(X_train, y_train, X_val, y_val)

# Plotting the results
plt.figure(figsize=(12, 8))
plt.plot([p * 100 for p in percentages], accuracies, marker='o', label="Soft Margin SVM")

plt.title("Soft Margin SVM Validation Accuracy vs Training Data Percentage")
